...
#         return _hash.bcrypt.verify(password, self.hased_password)
...
#     data_lastUpdated = _sql.Column(_sql.DateTime, default=_dt.datetime.utcnow)

#     owner = _orm.relationship("users", back_populates="loads")
import datetime as _dt
